...
public class RegistrationScreenTest {
    ...
    @Test
    public void UsersShouldBeAbleToGoBackToTheIntroScreenFromTheRegistrationScreen(){
        Given.IAmOnTheRegistrationScreen(driver);
        When.IPressGoBackOnTheRegistrationScreen(driver);
        Then.IShouldBeOnTheIntroScreen(driver);
    }

    @Test
    public void UsersShouldBeAbleToRegister(){
        Given.IAmOnTheRegistrationScreen(driver);
        When.IEnterRandomDetails(driver);
        And.when.IAcceptTheTermsAndConditions(driver);
        And.when.ISubmitTheRegistrationForm(driver);
        Then.IShouldBeOnTheMainScreen(driver);
    }
}